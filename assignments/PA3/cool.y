...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <formals> formal_list formal_list_tail
    %type <formal> formal
    %type <expressions> expr_list expr_list_tail exprs
    %type <expression> expr let_expr nested_let
    %type <cases> case_body_list
    %type <case_> case_body
    ...
    */
    ...
    | let_expr
    { $$ = $1; }
    | CASE expr OF case_body_list ESAC
    { $$ = typcase($2, $4); }
    | NEW TYPEID
    { $$ = new_($2); }
    | ISVOID expr
